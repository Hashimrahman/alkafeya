...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-full bg-whatsapp p-4 text-white shadow-2xl shadow-whatsapp/40 transition-all hover:bg-whatsapp-dark sm:bottom-7 sm:right-7"
    >
      {/* pulsing ring */}
      ...
      {/* expand-on-hover label (desktop) */}
      <span className="relative hidden max-w-0 overflow-hidden whitespace-nowrap text-sm font-semibold transition-all duration-300 group-hover:max-w-[140px] sm:inline-block">
        Chat with us
      </span>
    </a>
  )
